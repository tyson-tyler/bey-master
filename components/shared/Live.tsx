...
const Live = () => {
  return (
    <div
      id="no-print"
      className="p-1 sticky top-0 w-full z-50 md:p-3 lg:p-3 flex shadow-sm  items-center bg-gray-100 dark:bg-gray-900 dark:text-white text-black  justify-between"
    >
