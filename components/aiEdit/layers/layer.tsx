...
export default function Layers() {
  ...
  return (
    <MCard
      layout
      className="basis-[320px]  shrink-0 lg:flex hidden scrollbar-thin scrollbar-track-secondary overflow-y-scroll scrollbar-thumb-primary scrollbar-thumb-rounded-full scrollbar-track-rounded-full overflow-x-hidden relative  flex-col shadow-2xl"
    >
