    ...
    <div className="relative ">
      ...
      <div className="relative p-[20px] flex mb-4 mt-4 flex-col justify-center items-center min-h-[274px] rounded-md w-full bg-contain bg-left bg-fixed ">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center">
          <h1
            id="heading"
            className="lg:mb-3 gap-3 mb-3  flex justify-center items-center text-center text-black dark:text-white  lg:text-5xl md:text-5xl sm:text-5xl text-4xl font-bold flex-wrap animate-fadeIn"
          >
            Hello
