...
import { uploadImage } from "@/server/upload-images";
...
import imageAnimation from "../../../../server/imageAnimation.json";
  ...
  if (!activeLayer.url)
    return (
      <Card
        {...getRootProps()}
        className={cn(
          " hover:cursor-pointer w-full hover:bg-secondary hover:border-primary transition-all  ease-in-out ",
          `${
            isDragActive
              ? "w-full animate-pulse border-primary bg-secondary"
              : ""
          }`
        )}
      >
